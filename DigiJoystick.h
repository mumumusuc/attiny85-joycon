...
void DigiJoystick_setX(byte value) {
    last_built_report[0] = value;
}

void DigiJoystick_setY(byte value) {
    last_built_report[1] = value;
}

void DigiJoystick_setXROT(byte value) {
    last_built_report[2] = value;
}

void DigiJoystick_setYROT(byte value) {
    last_built_report[3] = value;
}

void DigiJoystick_setZROT(byte value) {
    last_built_report[4] = value;
}

void DigiJoystick_setSLIDER(byte value) {
    last_built_report[5] = value;
}


void DigiJoystick_setButtons(unsigned char low, unsigned char high) {
...
struct {
    ...
    void (*delay)(long);
        ...
        .init = DigiJoystick_init,
        .update = DigiJoystick_update,
        .delay = DigiJoystick_delay,
};
